...
users_yml.each do |user|
  ...
  user.save!
  user.send(:avatar_url=, Faker::Avatar.image, timeout: 120, folder: "WeTrippy/Users/#{user.id}/")
...
experiences_yml.each do |experience|
  ...
  new_experience.send(:cover_url=, experiences_covers[counter], timeout: 120, folder: "WeTrippy/Experiences/Cover/#{new_experience.id}/")
  ...
  new_experience.send(:photo_urls=, unsplash_photos, timeout: 120, folder: "WeTrippy/Experiences/desc_photos/#{new_experience.id}/")
